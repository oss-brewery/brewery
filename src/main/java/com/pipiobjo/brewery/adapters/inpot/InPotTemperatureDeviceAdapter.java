...
@Slf4j
public class InPotTemperatureDeviceAdapter implements InPotTemperatureAdapter {
    ...
    public InPotTemperatureDeviceAdapter(InPotTemperatureConfigProperties config) {
        this.config = config;
